...
def convertList(setCode):
	...
	colors = [ 'W', 'U', 'B', 'R', 'G', 'P', 'L', 'O', 'N', 'K' ]
	guilds = [ 'WU', 'UB', 'BR', 'RG', 'GW', 'WB', 'UR', 'BR', 'RW', 'GU', 'PL', 'LO', 'ON', 'NK', 'KP', 'PO', 'LN', 'OK', 'NP', 'KL', 'WP', 'WL', 'WO', 'WN', 'WK', 'UP', 'UL', 'UO', 'UN', 'UK', 'BP', 'BL', 'BO', 'BN', 'BK', 'RP', 'RL', 'RO', 'RN', 'RK', 'GP', 'GL', 'GO', 'GN', 'GK' ]
	shards = [ 'WUB', 'UBR', 'BRG', 'RGW', 'GWU', 'WBG', 'URW', 'BGU', 'RWB', 'GUR', 'PLO', 'LON', 'ONK', 'NKP', 'POK', 'LNP', 'OKL', 'NPO', 'KLN', 'KPL', 'WPL', 'WLO', 'WON', 'WNK', 'WKP', 'WPO', 'WLN', 'WOK', 'WNP', 'WKL', 'UPL', 'ULO', 'UON', 'UNK', 'UKP', 'UPO', 'ULN', 'UOK', 'UNP', 'UKL', 'BPL', 'BLO', 'BON', 'BNK', 'BKP', 'BPO', 'BLN', 'BOK', 'BNP', 'BKL', 'RPL', 'RLO', 'RON', 'RNK', 'RKP', 'RPO', 'RLN', 'ROK', 'RNP', 'RKL', 'GPL', 'GLO', 'GON', 'GNK', 'GKP', 'GPO', 'GLN', 'GOK', 'GNP', 'GKL', 'WUP', 'UBP', 'BRP', 'RGP', 'GWP', 'WBP', 'URP', 'BRP', 'RWP', 'GUP', 'WUL', 'UBL', 'BRL', 'RGL', 'GWL', 'WBL', 'URL', 'BRL', 'RWL', 'GUL', 'WUO', 'UBO', 'BRO', 'RGO', 'GWO', 'WBO', 'URO', 'BRO', 'RWO', 'GUO', 'WUN', 'UBN', 'BRN', 'RGN', 'GWN', 'WBN', 'URN', 'BRN', 'RWN', 'GUN', 'WUK', 'UBK', 'BRK', 'RGK', 'GWK', 'WBK', 'URK', 'BRK', 'RWK', 'GUK' ] # and wedges
			...
			if 'Basic' in card['type']:
				...
				for c in colors:
					if colorEquals(card['color_identity'], c):
						cards_sorted[c + 'F'].append(card)
						assigned = True
				for guild in guilds:
					if colorEquals(card['color_identity'], guild):
						cards_sorted[guild + 'F'].append(card)
						assigned = True
				if not assigned:
					cards_sorted['F'].append(card)
			else:
